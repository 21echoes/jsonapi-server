...
postProcess.fetchForeignKeys = (request, items, schema, callback) => {
  // The original implementation removed relationship data if it was a back-link.
  // This fork thinks that its reasoning[1] is rather myopic about how REST servers work
  // [1]: https://github.com/holidayextras/jsonapi-server/blob/master/documentation/foreign-relations.md#problem-supporting-back-links
  return callback()
}
